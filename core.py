...
from config import odines_username_rpa, odines_password_rpa, sed_username, sed_password, sprut_username, sprut_password, \
    tg_token
from rpamini import App, kill_process_list, ApplicationException, RobotException, BusinessException, Web
from tools import clipboard_set, clipboard_get
...
class PostHandler(logging.Handler):
    def __init__(self, chat_id, *args, **kwargs):
        ...
        self.url = f'https://api.telegram.org/bot{tg_token}/sendMessage'
...
# ? tested
def init_logger(logger_name: str = None, level: int = None, logger_format: str = None, tg_chat_id: str = None,
                orc_file_path: Union[Path, str] = None) -> logging.Logger:
